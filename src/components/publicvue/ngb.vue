...
<<<<<<< HEAD
  <div class="header">
    <div>
      <a class="logo" href="/">
        <img
          src="https://lf1-cdn2-tos.bytegoofy.com/bcy/image/logo-home.ac29f0.png"
          alt="半次元"
        />
      </a>
      <div class="nav_ul">
      ...
      <div class="regist" v-if="isLogin">
        ...
        <span @click="rest()">注册</span>
      </div>
      <el-avatar
        v-else
        style="vertical-align: middle; margin: 0 20px"
        :size="35"
    ...
    <div class="login_box" v-if="isLoginBox">
      <p>sss</p>
      <input type="text" />
      <button>sss</button>
    </div>
